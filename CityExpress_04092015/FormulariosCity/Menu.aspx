...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <%--<div class="page-content">--%>
        <div style="height: 100%;">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="nombre_hotel" runat="server" Text="City Express Plus Santa Fe" Font-Size="X-Large" ForeColor="Black"></asp:Label>
            <br />
            <div class="row" style="height: 100%">
                ...
                <div style="text-align:center;">Formatos de mantenimiento</div>
                    ...
                    <div class="tile bg-blue fg-white live-tile" data-mode="flip">
                      ...
                      <div class="tile bg-lightBlue  live-tile" data-mode="flip" data-delay="4000" onclick="window.location='Bitacora.aspx';">
                        <div style="text-align: center;">
