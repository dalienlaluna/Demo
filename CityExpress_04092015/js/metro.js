...
(function (factory) {
    ...
    window.METRO_LOCALES = {
        'en': {
            months: [
                "Enero", "Ferbrero", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Agosto", "Septiembre", "Octubre", "Novimbre", "Dicimbre",
        ...
        _renderMonth: function () {
            ...
            for (i = 1; i <= daysInMonth; i++) {
                ...
                if (year === this._today.getFullYear() && month === this._today.getMonth() && this._today.getDate() === i) {
                    td.addClass("today");
                    td.href = "BitacoraMantenimiento.aspx"
                    $(i).attr('href', "BitacoraMantenimiento.aspx");
                    //document.getElementById(i).setAttribute("href", "BitacoraMantenimiento.aspx");
                }
                if (this._today.getDate() > i) {
                    if (year === this._today.getFullYear() && month === this._today.getMonth() && this._today.getDate() - 2 <= i) {
                        td.addClass("todayRed");
                        //va a BitacoraMantenimiento.aspx
                        td.href = "BitacoraMantenimiento.aspx"
                        $(i).attr('href', "BitacoraMantenimiento.aspx");
                        //document.getElementById(i).setAttribute("href", "BitacoraMantenimiento.aspx");
                    }

                    if (year === this._today.getFullYear() && month === this._today.getMonth() && this._today.getDate() - 3 === i) {
                        td.addClass("todayYellow");
                        //alert
                        td.onClick = function () { alert('Día de registro inválido'); };
                        td.href = "#";
                        // document.getElementById(i).setAttribute("href", "BitacoraMantenimiento.aspx");
                        td.attr('href', "BitacoraMantenimiento.aspx");
                    }

                    if (year === this._today.getFullYear() && month === this._today.getMonth() && this._today.getDate() - 3 > i) {
                        td.addClass("todayGreen");
                        //este va a BitacoraResultados.aspx
                        td.href = "BitacoraResultados.aspx"
                        $(i).attr('href', "BitacoraResultados.aspx");
                        //  document.getElementById(i).setAttribute("href", "BitacoraResultados.aspx");
                    }
                }
